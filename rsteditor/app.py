...
class MainWindow(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.settings = settings = QtCore.QSettings(__app_name__, 'config')
        # status bar
        self.statusBar().showMessage(self.tr('Ready'))
        # action
        ## file
        newAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&New'), self)
        newAction.setShortcut('Ctrl+N')
        newAction.triggered.connect(self.onNew)
        openAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Open'), self)
        openAction.setShortcut('Ctrl+O')
        openAction.triggered.connect(self.onOpen)
        saveAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Save'), self)
        saveAction.setShortcut('Ctrl+S')
        saveAction.triggered.connect(self.onSave)
        saveAsAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('Save as...'), self)
        saveAsAction.triggered.connect(self.onSaveAs)
        exitAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Exit'), self)
        exitAction.setShortcut('Ctrl+Q')
        exitAction.triggered.connect(self.close)
        ## edit
        self.undoAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Undo'), self)
        self.undoAction.setShortcut('Ctrl+Z')
        self.undoAction.triggered.connect(partial(self.onEdit, 'undo'))
        self.redoAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Redo'), self)
        self.redoAction.setShortcut('Shift+Ctrl+Z')
        self.redoAction.triggered.connect(partial(self.onEdit, 'redo'))
        self.cutAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('Cu&t'), self)
        self.cutAction.setShortcut('Ctrl+X')
        self.cutAction.triggered.connect(partial(self.onEdit, 'cut'))
        self.copyAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Copy'), self)
        self.copyAction.setShortcut('Ctrl+C')
        self.copyAction.triggered.connect(partial(self.onEdit, 'copy'))
        self.pasteAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Paste'), self)
        self.pasteAction.setShortcut('Ctrl+V')
        self.pasteAction.triggered.connect(partial(self.onEdit, 'paste'))
        self.deleteAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Delete'), self)
        self.deleteAction.setShortcut('Del')
        self.deleteAction.triggered.connect(partial(self.onEdit, 'delete'))
        self.selectallAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('Select &All'), self)
        self.selectallAction.setShortcut('Ctrl+A')
        self.selectallAction.triggered.connect(partial(self.onEdit, 'selectall'))
        self.findAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Find'), self)
        self.findAction.setShortcut('Ctrl+F')
        self.findAction.triggered.connect(partial(self.onEdit, 'find'))
        self.findnextAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('Find next'), self)
        self.findnextAction.setShortcut('F3')
        self.findnextAction.triggered.connect(partial(self.onEdit, 'findnext'))
        self.findprevAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('Find previous'), self)
        ...
        self.explorerAction.setChecked(settings.value('view/explorer', True).toBool())
        ...
        self.webviewAction.setChecked(settings.value('view/webview', True).toBool())
        ...
        self.codeviewAction.setChecked(settings.value('view/codeview', True).toBool())
        ## preview
        previewAction = QtGui.QAction(QtGui.QIcon('exit.png'), self.tr('&Preview'), self)
        ...
        previewsaveAction.setChecked(settings.value('preview/onsave', True).toBool())
        ...
        previewinputAction.setChecked(settings.value('preview/oninput', True).toBool())
        ...
        previewsyncAction.setChecked(settings.value('preview/sync', True).toBool())
        ## help
