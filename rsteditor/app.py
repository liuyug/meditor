...
class MainWindow(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.explorerAction.setChecked(settings.value('view/explorer').toBool())
        ...
        self.webviewAction.setChecked(settings.value('view/webview').toBool())
        ...
        self.codeviewAction.setChecked(settings.value('view/codeview').toBool())
        ## preview
        ...
        previewsaveAction.setChecked(settings.value('preview/onsave').toBool())
        ...
        previewinputAction.setChecked(settings.value('preview/oninput').toBool())
        ...
        previewsyncAction.setChecked(settings.value('preview/sync').toBool())
        ## help
